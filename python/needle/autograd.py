...
def compute_gradient_of_variables(output_tensor, out_grad):
    ...
    for i in reverse_topo_order:
      ...
      if not i.op:
        continue
      allgrads = i.op.gradient_as_tuple(grad, i)
      for ki in range(len(i.inputs)):
        if i.inputs[ki] not in node_to_output_grads_list:
          node_to_output_grads_list[i.inputs[ki]] = []
        node_to_output_grads_list[i.inputs[ki]].append(allgrads[ki])
    
    for node in node_to_output_grads_list.keys():
